...
$query=mysqli_query($con,"select * from pro where id='$id'");
...
<div id='<?php echo $id;?>' type=hidden></div>
<!-- Sub banner end -->
                ...
                <div id="propertiesDetailsSlider" class="carousel properties-details-sliders slide mb-60">
                    <div class="heading-properties">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="pull-left">
                                    <h3><?php echo $property_type;?></h3>
                                    <p><i class="fa fa-map-marker"></i> <?php echo $address;?></p>
                                </div>
                                <div class="p-r">
                                    <h3>Rs. <?php echo $price;?> Lakhs</h3>
...
$query=mysqli_query($con,"select * from images where proid='$id'");
$res=$query->fetch_assoc();
...
$img4=$res['image4'];
                        ...
                        <div class="active item carousel-item" data-slide-number="0">
                            <img src="admin/images/property/property/<?php echo $img;?>" class="img-fluid" alt="property-4">
                        </div>
                        <div class="item carousel-item" data-slide-number="1">
                            <img src="admin/images/property/<?php echo $img1;?>" class="img-fluid" alt="property-6">
                        </div>
                        <div class="item carousel-item" data-slide-number="2">
                            <img src="admin/images/property/<?php echo $img2;?>" class="img-fluid" alt="property-1">
                        </div>
                        <div class="item carousel-item" data-slide-number="4">
                            <img src="admin/images/property/<?php echo $img3;?>" class="img-fluid" alt="property-5">
                        </div>
                        <div class="item carousel-item" data-slide-number="5">
                            <img src="admin/images/property/<?php echo $img4;?>" class="img-fluid" alt="property-8">
                        </div>
                    ...
                    <div class="tab-content" id="carTabContent">
                        ...
                        <div class="tab-pane fade " id="5" role="tabpanel" aria-labelledby="5-tab">
                            <div class="section location">
                                ...
                                <iframe src="https://maps.google.com/maps?q=<?php echo $lat; ?>,<?php echo $lon; ?>&output=embed" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
...
$query=mysqli_query($con,"select * from pro ORDER BY RAND() LIMIT 2");
        ...
        ?>    
            <div class="col-md-6">
                <div class="property-box">
                    <div class="property-thumbnail">
                        <a href="properties-details.html" class="property-img">
                            ...
                            <div class="price-ratings-box">
                                <p class="price">
                                    Rs. <?php echo $res['price']-1;?>.99 Lakhs
                                </p>
                                <div class="ratings">
                            ...
                            <img src="admin/images/property/property/<?php echo $img;?>" alt="property-1" class="img-fluid">
                        </a>
                    ...
                    <div class="detail">
                        <h1 class="title">
                            <a href="properties-details.php?id=<?php echo $id;?>"><?php echo $res['type'];?></a>
                        </h1>
                        <div class="location">
                            <a href="properties-details.php?id=<?php echo $id;?>">
                                <i class="fa fa-map-marker"></i><?php echo $res['location'];?>
                            </a>
                        </div>
...
<?php } ?>
                ...
                <div class="amenities-box mb-60">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <ul>
                                <li><span><i class="flaticon-square-layouting-with-black-square-in-east-area"></i> <?php echo $price;?> sq ft</span></li>
                    ...
                    <ul class="comments">
                        <li>
                            <div class="comment">
                                <div class="comment-author">
                                    <a href="#">
                                        <img src="assets/img/avatar/arpan.jpeg" class="rounded-circle" alt="avatar-13">
                                    </a>
                                </div>
                                <div class="comment-content">
                                    ...
                                    <div class="comment-body">
                                        ...
                                        <p>This flat is top notch with the best of facilities</p>
                                    </div>
                                </div>
                            </div>
                            <ul>
                                <li>
                                    <div class="comment">
                                        <div class="comment-author">
                                            <a href="#">
                                                <img src="assets/img/avatar/arnab.jpeg" class="rounded-circle" alt="avatar-13">
                                            </a>
                                        </div>
                                        ...
                                        <div class="comment-content">
                                            ...
                                            <div class="comment-body">
                                                ...
                                                <p>This flat can be a bit better with the addition of little more furniture</p>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                        ...
                        <li>
                            <div class="comment">
                                <div class="comment-author">
                                    <a href="#">
                                        <img src="assets/img/avatar/abhishek.jpg" class="rounded-circle" alt="avatar-13">
                                    </a>
                                </div>
                                <div class="comment-content">
                                    <div class="comment-meta">
                                    ...
                                    <div class="comment-body">
                                        ...
                                        <p>One of the best types of Flat with well divided segmented plan of rooms.</p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="sidebar mbl">
                    ...
                    <div class="widget recent-posts">
                        ...
                        <div class="media mb-4">
                            ...
                            <div class="media-body align-self-center">
                                ...
                                <p> <strong>Rs. 25.99 Lakhs</strong></p>
                            </div>
                        </div>
                        <div class="media mb-4">
                            <a href="properties-details.html">
                            ...
                            <div class="media-body align-self-center">
                                ...
                                <p>February 27, 2018</p>
                                <p> <strong>Rs. 59.99 Lakhs</strong></p>
                            </div>
                        </div>
                        <div class="media">
                            <a href="properties-details.html">
                            ...
                            <div class="media-body align-self-center">
                                <h5>
                                    <a href="properties-details.html">Real Luxury House</a>
                                </h5>
                                <p>February 27, 2018</p>
                                <p> <strong>Rs. 79.99 Lakhs</strong></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="social-list widget clearfix">
                        ...
                        <ul>
                            ...
                            <li><a href="https://twitter.com/explore" class="twitter-bg"><i class="fa fa-twitter"></i></a></li>
                            <li><a href="https://www.google.com/" class="google-bg"><i class="fa fa-google-plus"></i></a></li>
                            <li><a href="https://rss.com/" class="rss-bg"><i class="fa fa-rss"></i></a></li>
                            <li><a href="https://in.linkedin.com/" class="linkedin-bg"><i class="fa fa-linkedin"></i></a></li>
                        </ul>
                    </div>
                    ...
                    <div class="helping-center widget clearfix">
                        <div class="media">
                            ...
                            <div class="media-body  align-self-center">
                                ...
                                <h4><a href="tel:+0477-85x6-552">+91 8597768318</a></h4>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="footer-item">
                    ...
                    <ul class="contact-info">
                        <li>
                            Address: Hill cart Road, LR Apartment, 1st Phase JP Nagar, Bangalore
                        </li>
                        <li>
                            Email: <a href="mailto:info@themevessel.com">houseinfo@gmail.com</a>
                        </li>
                        <li>
                            Phone: <a href="tel:+0477-85x6-552">+91 8595768318</a>
                        </li>
                    </ul>

                    <ul class="social-list clearfix">
                        <li><a href="https://www.facebook.com/" class="facebook"><i class="fa fa-facebook"></i></a></li>
                        <li><a href="https://twitter.com/explore" class="twitter"><i class="fa fa-twitter"></i></a></li>
                        <li><a href="https://www.google.com/" class="google"><i class="fa fa-google-plus"></i></a></li>
                        <li><a href="https://rss.com/" class="rss"><i class="fa fa-rss"></i></a></li>
                        <li><a href="https://in.linkedin.com/" class="linkedin"><i class="fa fa-linkedin"></i></a></li>
                    </ul>
                </div>
            </div>
            <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6">
                <div class="footer-item">
                    ...
                    <ul class="links">
                        <li>
                            <a href="contact.php"><i class="fa fa-angle-right"></i>About us</a>
                        </li>
                        <li>
                            <a href="contact.php"><i class="fa fa-angle-right"></i>Service</a>
                        </li>
                        <li>
                            <a href="properties.php"><i class="fa fa-angle-right"></i>Properties Listing</a>
                        </li>
                        <li>
                            <a href="properties.php"><i class="fa fa-angle-right"></i>Properties Grid</a>
                        </li>
                        <li>
                            <a href="contact.php"><i class="fa fa-angle-right"></i>Contact Us</a>
                        </li>
                        <li>
                            <a href="properties.php"><i class="fa fa-angle-right"></i>Property Details</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="footer-item clearfix">
                    ...
                    <div class="Subscribe-box">
                        <p>To get more updates regarding the best properties tune in to our website and subscribe it.</p>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <p>
                    <i class="flaticon-facebook-placeholder-for-locate-places-on-maps"></i> Electronic City
                </p>
                    ...
                    <div class="col-lg-6 modal-left">
                        <div class="modal-left-content">
                            ...
                            <div class="description"><h3>Description</h3>
                                <p>
                                   One of the best properties to get at an amazing price.
                                </p>
                            </div>
                        </div>
                    </div>
...
<div class="off-canvas-sidebar">
    <div class="off-canvas-sidebar-wrapper">
        ...
        <div class="off-canvas-content">
            ...
            <aside class="canvas-widget">
                <ul class="menu">
                    <li class="index.php"><a href="index.html">Home</a></li>
                    <li class="properties.php"><a href="properties-grid-leftside.html">Properties List</a></li>
                    <li class="properties.php"><a href="properties-details.html">Property Detail</a></li>
                    <li class="about.php"><a href="about-1.html">About  US</a></li>
                    <li class="contact.php"><a href="contact-1.html">Contact US</a></li>
                </ul>
            </aside>
            <aside class="canvas-widget">
...
<script
      src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC1JZHpxIke_OtBO3W22B548yKIqSXYsQU&callback=initMap&libraries=&v=weekly"
      defer
    ></script>
